...
- Preview and downloads are always rasterized/vectorized at a fixed 2000px long edge, regardless of the uploaded image's size.
- **Color** mode dithers against a reorderable, removable palette of 2–7 colors chosen from a fixed set (white + 6 brand colors) — no free-form hex entry. **Black & White** mode dithers to pure black/white.
